...
//
//  Created by joseph hoffman on 2/25/14.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ManagerTableViewController *managerTableViewController = [[ManagerTableViewController alloc] initWithManagedObjectContxt:self.managedObjectContext];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Recipe_33___Using_Core_Data" withExtension:@"momd"];
